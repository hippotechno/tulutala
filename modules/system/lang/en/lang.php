...
return [
    ...
    'event_log' => [
        ...
        'details' => [
            ...
            'ajax' => 'AJAX',
            'route' => 'Route',
            'input_keys' => 'Input fields',
            'checked' => 'checked',
            'first_app_frame' => 'First application frame before the exception',
            ...
            'cli_queue' => 'CLI / Queue',
            'no_authenticated_actor' => 'No authenticated user was detected for this request.',
            'generic_log' => 'Generic log details',
            'no_structured_details' => 'This event did not include structured exception metadata, so only the recorded message and raw details are available.',

...
return [
    ...
    'event_log' => [
        ...
        'details' => [
            ...
            'profile' => 'profile',
            'space' => 'space',
            'request_flow' => 'Luồng request',
            'path' => 'Path',
            'canonical_url' => 'Canonical URL',
            'host' => 'Host',
            'ajax' => 'AJAX',
            'route' => 'Route',
            'input_keys' => 'Field gửi lên',
            'checked' => 'checked',
            'first_app_frame' => 'Frame trong ứng dụng gần nhất trước khi lỗi',
            'diagnostic_context' => 'Diagnostic context',
            'request_diagnostics' => 'Request diagnostics',
            'safe_input' => 'Safe input',
            'bulk_action' => 'Bulk action',
            'hippo_context' => 'Hippo context',
            'cli_queue' => 'CLI / Queue',
            'no_authenticated_actor' => 'Không phát hiện user đã đăng nhập trong request này.',
            'generic_log' => 'Chi tiết log thường',
            'no_structured_details' => 'Event này không có metadata exception dạng đầy đủ, nên chỉ hiển thị được message đã ghi và raw details.',
            'raw_details' => 'Raw details',
            'testing' => 'Testing',
            'exception_context' => 'Ngữ cảnh exception',
            'exception_app_env' => 'Môi trường exception',
            'exception_encountered_backend' => 'Exception xảy ra trong Backend',
            'exception_encountered_unit_test' => 'Exception xảy ra trong unit test',
            'oldest_first' => 'Cũ nhất trước',
            'newest_first' => 'Mới nhất trước',
            'exception_index' => 'Thứ tự exception',
            'exception' => 'Exception',
            'exception_code' => 'Mã exception',
            'code' => 'Mã',

...
return [
    ...
    'list' => [
        ...
        'search_help_intro' => 'You can search by a general keyword, or target a specific column when you want more precise results.',
        'search_help_syntax_label' => 'Common ways to search',
        'search_help_syntax_keyword_label' => 'Search everything',
        'search_help_syntax_keyword' => 'nam du',
        'search_help_syntax_keyword_desc' => 'Type a normal keyword to search across all searchable columns.',
        'search_help_syntax_field_label' => 'Search one column',
        'search_help_syntax_field' => 'name:nam du',
        'search_help_syntax_field_desc' => 'Add the column name first if you only want to search in that column. When the value contains multiple words, it will match the full phrase in that column.',
        'search_help_syntax_phrase_label' => 'Search an exact phrase',
        'search_help_syntax_phrase' => 'name:"nam du"',
        'search_help_syntax_phrase_desc' => 'This also matches the full phrase. Quotes simply make the search easier to read when the value contains spaces.',
        'search_help_syntax_multi_label' => 'Search across multiple columns at once',
        'search_help_syntax_multi' => 'name:nam du hien-thi:có',
        'search_help_syntax_multi_desc' => 'You can combine multiple column conditions in one search. Results must match every condition you enter.',
        'search_help_alias_label' => 'How column names become search aliases',
        'search_help_alias_desc' => 'Column names are converted to lowercase ASCII with hyphens. Example: "Năm sinh" becomes "nam-sinh", and "Hiển thị?" becomes "hien-thi".',
        'search_help_fields_label' => 'Searchable columns',
        'search_help_field_prefix' => 'You can type',
        'search_help_boolean_values' => 'For yes/no columns, you can enter: Có/Không, co/khong, true/false, or 1/0.',
        'search_help_aliases' => 'Other names',
        'search_help_examples_label' => 'Quick examples',
        'search_help_example_keyword' => 'arrow icon',
        'search_help_example_keyword_desc' => 'Search across multiple columns:',
        'search_help_example_field' => 'name:nam du',
        'search_help_example_field_desc' => 'Search only the Name column, matching the full phrase "nam du":',
        'search_help_example_phrase' => 'name:"nam du"',
        'search_help_example_phrase_desc' => 'The quoted version is equivalent, but easier to read:',
        'search_help_example_multi' => 'name:nam du hien-thi:có',
        'search_help_example_multi_desc' => 'Combine multiple columns in one search:',
        'search_help_example_boolean' => 'hien-thi:có',
        'search_help_example_boolean_desc' => 'Filter a yes/no value:',

...
return [
    ...
    'list' => [
        ...
        'search_help_intro' => 'Use keywords for general search or field prefixes to narrow the results to a specific column.',
        'search_help_syntax_label' => 'Syntax',
        'search_help_syntax_keyword' => 'keyword',
        'search_help_syntax_keyword_desc' => 'Search all searchable columns.',
        'search_help_syntax_field' => 'field:value',
        'search_help_syntax_field_desc' => 'Search a specific field alias.',
        'search_help_syntax_phrase' => 'field:"multi word value"',
        'search_help_syntax_phrase_desc' => 'Search a specific field with a value that contains spaces.',
        'search_help_fields_label' => 'Available fields',
        'search_help_boolean_values' => 'Boolean values: Có/Không, co/khong, true/false, 1/0',
        'search_help_aliases' => 'Other aliases',
        'search_help_examples_label' => 'Examples',

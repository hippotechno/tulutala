...
return [
    ...
    'list' => [
        ...
        'search_help_intro' => 'Dùng từ khóa để tìm tổng quát hoặc thêm tiền tố field để thu hẹp kết quả vào một cột cụ thể.',
        'search_help_syntax_label' => 'Cú pháp',
        'search_help_syntax_keyword' => 'tukhoa',
        'search_help_syntax_keyword_desc' => 'Tìm trên tất cả các cột có hỗ trợ tìm kiếm.',
        'search_help_syntax_field' => 'field:giatri',
        'search_help_syntax_field_desc' => 'Tìm theo một field alias cụ thể.',
        'search_help_syntax_phrase' => 'field:"gia tri nhieu tu"',
        'search_help_syntax_phrase_desc' => 'Tìm theo field cụ thể với giá trị có khoảng trắng.',
        'search_help_fields_label' => 'Các field khả dụng',
        'search_help_boolean_values' => 'Giá trị boolean: Có/Không, co/khong, true/false, 1/0',
        'search_help_aliases' => 'Alias khác',
        'search_help_examples_label' => 'Ví dụ',
        'search_help_example_keyword' => 'mui ten icon',
        'search_help_example_field' => 'name:arrow',
        'search_help_example_phrase' => 'collection:"hero icons"',

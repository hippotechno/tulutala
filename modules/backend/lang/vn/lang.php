...
return [
    ...
    'list' => [
        ...
        'search_help_title' => 'Hướng dẫn tìm kiếm',
        'search_help_intro' => 'Bạn có thể tìm theo từ khóa chung hoặc chỉ định rõ một cột nếu muốn lọc chính xác hơn.',
        'search_help_syntax_label' => 'Cách tìm thường dùng',
        'search_help_syntax_keyword_label' => 'Tìm chung',
        'search_help_syntax_keyword' => 'nam du',
        'search_help_syntax_keyword_desc' => 'Gõ từ khóa bình thường để tìm trên toàn bộ các cột có hỗ trợ tìm kiếm.',
        'search_help_syntax_field_label' => 'Tìm trong một cột',
        'search_help_syntax_field' => 'ten:nam du',
        'search_help_syntax_field_desc' => 'Thêm tên cột phía trước để chỉ tìm trong đúng cột đó. Nếu có nhiều chữ, hệ thống sẽ tìm theo cả cụm trong cột này.',
        'search_help_syntax_phrase_label' => 'Tìm đúng một cụm từ',
        'search_help_syntax_phrase' => 'ten:"nam du"',
        'search_help_syntax_phrase_desc' => 'Cách viết này cũng tìm đúng cả cụm từ. Dấu ngoặc kép giúp câu lệnh dễ đọc hơn khi giá trị có khoảng trắng.',
        'search_help_syntax_multi_label' => 'Tìm cùng lúc nhiều cột',
        'search_help_syntax_multi' => 'ten:nam du hien-thi:có',
        'search_help_syntax_multi_desc' => 'Bạn có thể ghép nhiều điều kiện trên nhiều cột. Kết quả sẽ lấy các bản ghi thỏa tất cả điều kiện đã nhập.',
        'search_help_alias_label' => 'Tên cột để gõ khi tìm',
        'search_help_alias_desc' => 'Tên cột sẽ được đổi sang dạng không dấu, viết thường và nối bằng dấu gạch ngang. Ví dụ: "Năm sinh" thành "nam-sinh", "Hiển thị?" thành "hien-thi".',
        'search_help_fields_label' => 'Các cột có thể tìm',
        'search_help_field_prefix' => 'Bạn có thể gõ',
        'search_help_boolean_values' => 'Với cột bật/tắt, bạn có thể nhập: Có/Không, co/khong, true/false hoặc 1/0.',
        'search_help_aliases' => 'Cách gọi khác',
        'search_help_examples_label' => 'Ví dụ dễ dùng',
        'search_help_example_keyword' => 'mui ten icon',
        'search_help_example_keyword_desc' => 'Tìm chung trên nhiều cột:',
        'search_help_example_field' => 'ten:nam du',
        'search_help_example_field_desc' => 'Chỉ tìm trong cột Tên, và tìm theo cả cụm "nam du":',
        'search_help_example_phrase' => 'ten:"nam du"',
        'search_help_example_phrase_desc' => 'Viết rõ bằng dấu ngoặc kép nếu bạn muốn đọc dễ hơn:',
        'search_help_example_multi' => 'ten:nam du hien-thi:có',
        'search_help_example_multi_desc' => 'Kết hợp nhiều cột trong cùng một lần tìm:',
        'search_help_example_boolean' => 'hien-thi:có',
        'search_help_example_boolean_desc' => 'Lọc theo giá trị Có / Không:',
